...
xst -ifn xst.scr
move M_Clk_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\M_Clk_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc M_Clk_exdes.ucf M_Clk_exdes

echo 'Running map'
map -timing -pr b M_Clk_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm M_Clk_exdes -w routed.ncd routed.vhd
cd ..
